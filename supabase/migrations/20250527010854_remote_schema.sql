...
CREATE TABLE IF NOT EXISTS "public"."projects" (
    ...
    "min_funding" double precision DEFAULT '0'::double precision NOT NULL,
    "funding_goal" double precision DEFAULT '0'::double precision NOT NULL,
    "founder_shares" integer DEFAULT 0 NOT NULL,
    "type" public.project_type DEFAULT 'grant'::public.project_type NOT NULL,
    "stage" public.project_stage DEFAULT 'draft'::public.project_stage NOT NULL,
    "round" text,
    "slug" text NOT NULL,
    ...
    "public_benefit" text,
    "admin_id" uuid,
    "admin_comment_id" uuid,
    "admin_verdict" boolean,
    "admin_verdict_at" timestamp with time zone,
    "admin_verdict_reason" text,
    "admin_verdict_amount" double precision,
    "admin_verdict_token" text,
    "admin_verdict_txn_id" uuid,
    "auction_close" timestamp with time zone,
