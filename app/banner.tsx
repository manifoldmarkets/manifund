...
export function CompleteProfileBanner() {
  return (
    <div className="relative isolate -mx-2 mb-6 flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
      <svg
        viewBox="0 0 577 310"
        aria-hidden="true"
...
export function ManifestBanner() {
  const [showBanner, setShowBanner] = useState(true)
  if (!showBanner) return null
  return (
    <div className="relative isolate -mx-2 mb-6 flex items-center gap-x-6 overflow-hidden py-2.5 px-6 sm:px-3.5 sm:before:flex-1">
      <svg
        viewBox="0 0 577 310"
        aria-hidden="true"
        className="absolute top-1/2 left-[max(-7rem,calc(50%-52rem))] -z-10 w-[36.0625rem] -translate-y-1/2 transform-gpu blur-2xl"
      ...
      <p className="w-full text-center text-sm leading-6 text-gray-900">
        <a href="https://www.manifestconference.net/">
          Get tickets to <strong className="font-semibold">Manifest</strong>
          —forecasting festival, Sep 22-24, Berkeley, CA
        </a>
      </p>
