  ...
  return (
    <Col className="gap-4 p-5">
      ...
      <Row className="items-center gap-1">
        ...
        <Tooltip
          text="Check this box if you will use this money to lobby (attempt to influence legislation, as defined by the IRS), within the US or internationally."
          className="flex"
        >
