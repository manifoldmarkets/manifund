...
export function GrantAgreement(props: { project: ProjectAndProfile; agreement?: GrantAgreement }) {
      ...
      <tbody>
        ...
        <tr>
          ...
          <td className="flex flex-col gap-2">
            <p>
              1.1 Manifold for Charity, 1621 E 6th Street Unit 1440, Austin, TX 78702, United
              States, a registered 501(c)3-nonprofit with EIN 88-3668801 (the “Charity”).
            </p>
            <p>
              1.2 {signed ? agreement.recipient_name : project.profiles.full_name} (the “Recipient”)
            </p>
            <p>
              1.3 Based on the information provided to Manifold for Charity, this grant is to be
              used exclusively for the following purposes in accordance with the terms and
              conditions of this letter, unless otherwise approved in advance [in writing] by
              Manifold for Charity: &quot;
              {signed ? agreement.project_title : project.title}&quot; (the “Project”).
            </p>
            <p>
              1.4 The start date for {version < 3 ? 'your grant' : 'this grant'} will be{' '}
              {format(new Date(project.created_at), 'MMMM do, yyyy')} (the “Commencement Date”) and
              will run for the duration (the “Grant Period”) until the Recipient marks the Project
              as complete (the “Expiry Date”).
            </p>
            {project.approved === null && (
              <p>
                1.5 The Charity has not yet decided to give this grant. Rather, it has been
                recommended to the Charity to give this grant. After the signing of this agreement,
                the Charity will review the grant application and may decide not to send funds to
                the Recipient if the Project is not in line with the Charity’s mission.
              </p>
            )}
          </td>
        </tr>
        ...
        <tr>
          ...
          <td className="flex flex-col gap-2">
            <p>
              2.1 The Grant is conditional on the satisfactory use of the money and on compliance
        ...
        <tr>
          ...
          <td className="flex flex-col gap-2">
            ...
            <Col className="gap-2 pl-5">
              <p>
                (a) Otherwise than for the purposes which fall within the charitable purposes of the
                Recipient, or to undertake an activity for any purpose other than a religious,
                charitable, scientific, literary, educational, or other purpose specified in Section
                170(c)(2)(B) of the Internal Revenue Code (“IRC”).
              </p>
              {!excludeLobbyingClause && (
                <p>
                  (b) To attempt to influence legislation, within the meaning of Section 501(c)(3)
                  of the IRC.
                </p>
              )}
              <p>
        ...
        <tr>
          ...
          <td className="flex flex-col gap-2">
            ...
            <p>
              ...
              If applicable, the Recipient shall receive instructions for submitting the report
              before it is due.
            </p>
          </td>
        </tr>
        <tr className="font-bold">
          ...
          <td className="pt-6 ">Payment, Withholding, and Recovery of the Grant</td>
        </tr>
        <tr>
          <td />
          <td className="flex flex-col gap-2">
            ...
            <Col className="gap-2 pl-5">
              ...
              <p>(e) the Recipient ceases to work on the Project for any reason.</p>
              <p>
            ...
            <p>
              ...
              has available funds. The Charity does it all it can to keep fees low and foreign
              exchange rates fair, however, due to the nature of these fees, the amount the
              Recipient receives may be reduced by bank transfer fees and, for international
              transfers, also by forex fees.
            </p>
            <p>
            ...
            <p>
              ...
              without prejudice to any other rights and remedies of the Charity, the Recipient
              shall, at the Charity’s sole discretion, return any remaining part of the Grant to the
              Charity, or any money that has not been used in accordance with Section 2 of this
              Agreement.
            </p>
            <p>
              5.5 The Charity will make the payment using the standard payment routes, but the onus
              is on the Recipient to help the Charity complete the payment if those routes fail, for
        ...
        {version === 1 && (
          <>
            ...
            <tr>
              ...
              <td className="flex flex-col gap-2">
                <p>
                  6.1 The Recipient agrees not to make any press release, media announcement, any
                  other major public relations activity in respect of the Grant or the relationship
                  between the parties without the prior written consent of the Charity, such consent
                  not to be unreasonably withheld.
                </p>
                <p>
                  6.2 The Recipient may make general and non-detailed references to the Charity’s
                  support of the Recipient during the course of the Project.
                </p>
              </td>
            </tr>
          </>
        ...
        <tr>
          <td />
          <td>
            If applicable, the Recipient is responsible to pay when due all local taxes, duties, and
            other governmental fees, taxes or other governmental charges that may apply to personal
            income. The Grant shall not be increased in the event of any tax become payable on the
            Grant money. The Grant may be classified as taxable income. It is up to the Recipient to
            check with an accountant or tax professional to see whether they need to declare the
        ...
        <tr className=" font-bold">
          <td className="pr-10 pt-6 text-gray-900">{version === 1 ? '10' : '9'}</td>
        ...
        <tr>
          ...
          <td>
            ...
            between the Recipient and the Charity.
          </td>
        </tr>
        <tr className=" font-bold">
          <td className="pr-10 pt-6 text-gray-900">{version === 1 ? '11' : '10'}</td>
        ...
        <tr className=" font-bold">
          <td className="pr-10 pt-6 text-gray-900">{version === 1 ? '12' : '11'}</td>
        ...
        <tr className="font-bold">
          <td className="pr-10 pt-6 text-gray-900">{version === 1 ? '13' : '12'}</td>
        ...
        <tr className=" font-bold">
          <td className="pr-10 pt-6 text-gray-900">{version === 1 ? '14' : '13'}</td>
        ...
        <tr className=" font-bold">
          <td className="pr-10 pt-6 text-gray-900">{version === 1 ? '15' : '14'}</td>
